export const labelEmployeeVi = [
  ...
  // { key: 'user_working_histories', name: 'Quá trình công tác' },
  // { key: 'social_network', name: 'Mạng xã hội' },
...
export const labelEmployeeEn = [
  ...
  // { key: 'user_working_histories', name: 'Working process' },
  // { key: 'social_network', name: 'Social network' },
